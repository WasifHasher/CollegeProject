        ...
        <div class="container mt-5">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-5 border border-primary shahow bg-white rounded mt-3" style="height:500px">
                    <h3 style="margin-left:50px; width:430px" class="mt-5 btn btn-danger fs-3">Registration Form</h3>
                        <form action="/Saveregister" method="POST" class="mt-3">
                            ...
                            <button class="btn btn-danger mt-4 py-2" style="width:430px;margin-left:50px;">Submit</button>
