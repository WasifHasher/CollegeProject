            ...
            <div class="col-6 mt-5 border border-primary shadow p-3 rounded bg-white py-4 me-2">
                ...
                <form action="Saveslider" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-4">
                        <input type="text" name="title" placeholder="Title" value="{{ old('title')}}" class="form-Control w-100 p-2 rounded border @error('title') is-invalid @enderror">
                        @error('title')<span class="text-danger">{{ $message}}</span>@enderror
                    </div>

                    <div class="form-group mt-3">
                        <input type="text" name="description" placeholder="description" value="{{ old('description')}}" class="form-Control w-100 p-2 border rounded @error('description') is-invalid @enderror">
